namespace Company.Graphql.Blocks.Presentation.Api.Configuration
{
    using Company.Graphql.Blocks.Common.Exceptions;
    ...
    public static class ServiceCollectionExtensions
    {
            ...
            Type[]? knownExceptionTypes = null)
        {
            ...
            knownExceptionTypes ??= new[] { typeof(ValidationException), typeof(NotFoundException) };
